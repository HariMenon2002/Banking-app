...
const Home = async ({searchParams:{id,page}}:SearchParamProps) => {
 ...
 console.log("let us see the accoutsData and account")
 const account= await getAccount({appwriteItemId});
  ...
  return (
    <section className='home'> 
        ...
        <RightSidebar user={loggedIn} transactions={account?.transactions} banks={accounts?.data?.slice(0,2)}></RightSidebar>
    </section> 
